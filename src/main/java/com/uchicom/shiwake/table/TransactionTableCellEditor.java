...
public class TransactionTableCellEditor implements TableCellEditor {
	...
	public TransactionTableCellEditor(Vector<Account> accountList, TransactionType type, ShiwakeFrame shiwakeFrame) {
		this.type = type;
	...
	public boolean stopCellEditing() {
		...
		if (returnComponent instanceof JTable) {
			...
			shiwakeFrame.getTable().editingStopped(new ChangeEvent(shiwakeFrame.getTable()));
//			table.repaint();
		} else {
			System.out.println("not jtable");
			shiwakeFrame.getTable().editingStopped(new ChangeEvent(shiwakeFrame.getTable()));
			//shiwakeFrame.getModel().fireTableDataChanged();
		}
